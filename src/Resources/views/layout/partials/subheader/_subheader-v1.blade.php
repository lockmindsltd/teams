...
<div class="subheader py-2 {{ \Modules\Taskmanager\Classes\Theme\Metronic::printClasses('subheader', false) }}" id="kt_subheader">
    <div class="{{ \Modules\Taskmanager\Classes\Theme\Metronic::printClasses('subheader-container', false) }} d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <h5 class="text-dark font-weight-bold my-2 mr-5">
                ...
                @if (isset($page_description) && config('taskmanager.layout.subheader.displayDesc'))
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
                <a href="#" class="btn btn-icon"data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    {{ \Modules\Taskmanager\Classes\Theme\Metronic::getSVG("media/svg/icons/Files/File-plus.svg", "svg-icon-success svg-icon-2x") }}
                </a>
