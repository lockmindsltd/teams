@php
	$direction = config('taskmanager.layout.extras.quick-actions.offcanvas.direction', 'right');
@endphp
{{-- Quick Actions Panel --}}
<div id="kt_quick_actions" class="offcanvas offcanvas-{{ $direction }} p-10">
	...
	<div class="offcanvas-content pr-5 mr-n5">
		<div class="row gutter-b">
			...
			<div class="col-6">
				<a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
		            {{ \Modules\Taskmanager\Classes\Theme\Metronic::getSVG("media/svg/icons/Shopping/Euro.svg", "svg-icon-3x svg-icon-primary m-0") }}
			...
			<div class="col-6">
				<a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
		            {{ \Modules\Taskmanager\Classes\Theme\Metronic::getSVG("media/svg/icons/Communication/Mail-attachment.svg", "svg-icon-3x svg-icon-primary m-0") }}
		...
		<div class="row gutter-b">
			...
			<div class="col-6">
				<a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
		            {{ \Modules\Taskmanager\Classes\Theme\Metronic::getSVG("media/svg/icons/Shopping/Box2.svg", "svg-icon-3x svg-icon-primary m-0") }}
			...
			<div class="col-6">
				<a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
		            {{ \Modules\Taskmanager\Classes\Theme\Metronic::getSVG("media/svg/icons/Communication/Group.svg", "svg-icon-3x svg-icon-primary m-0") }}
		...
		<div class="row gutter-b">
			...
			<div class="col-6">
				<a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
		            {{ \Modules\Taskmanager\Classes\Theme\Metronic::getSVG("media/svg/icons/Shopping/Chart-bar1.svg", "svg-icon-3x svg-icon-primary m-0") }}
			...
			<div class="col-6">
				<a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
		            {{ \Modules\Taskmanager\Classes\Theme\Metronic::getSVG("media/svg/icons/Design/Color-profile.svg", "svg-icon-3x svg-icon-primary m-0") }}
