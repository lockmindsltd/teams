@php
    $direction = config('taskmanager.extras.search.offcanvas.direction', 'right');
@endphp
{{-- Search Panel --}}
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            {{ \Modules\Taskmanager\Classes\Theme\Metronic::getSVG("media/svg/icons/General/Search.svg", "svg-icon-lg") }}
                        </span>
                    </div>
