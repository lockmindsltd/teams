{{-- Header --}}
@if (config('lm_team_layouts..extras.quick-actions.dropdown.style') == 'light')
...
<div class="row row-paddingless">
    ...
    <div class="col-6">
        <a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
            {{ \Lockminds\Teams\Classes\Metronic::getSVG("media/svg/icons/Shopping/Euro.svg", "svg-icon-3x svg-icon-success") }}
    ...
    <div class="col-6">
        <a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-bottom">
            {{ \Lockminds\Teams\Classes\Metronic::getSVG("media/svg/icons/Communication/Mail-attachment.svg", "svg-icon-3x svg-icon-success") }}
    ...
    <div class="col-6">
        <a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-right">
            {{ \Lockminds\Teams\Classes\Metronic::getSVG("media/svg/icons/Shopping/Box2.svg", "svg-icon-3x svg-icon-success") }}
    ...
    <div class="col-6">
        <a href="#" class="d-block py-10 px-5 text-center bg-hover-light">
            {{ \Lockminds\Teams\Classes\Metronic::getSVG("media/svg/icons/Communication/Group.svg", "svg-icon-3x svg-icon-success") }}
