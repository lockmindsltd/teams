                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="table-responsive">
                                           @php
                                                ...
                                                $tasks = $tasksModel::Where('task_creator',$user->id)->orWhere('task_responsible',$user->id)->leftJoin('lockminds_teams','lockminds_team_tasks.task_team','lockminds_teams.id')->get();
