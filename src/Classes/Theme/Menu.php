...
class Menu
{
    ...
    public static function renderVerMenu($item, $parent = null, $rec = 0, $singleItem = false)
    {
        ...
        if (isset($item['separator'])) {
            ...
            } elseif (config('lm_team_layouts.aside.menu.hide-root-icons') !== true && isset($item['icon']) && !empty($item['icon'])) {
            ...
            if (isset($item['submenu'])) {
                if (isset($item['root']) == false && config('lm_team_layouts.menu.aside.submenu.arrow') == 'plus-minus') {
                    echo '<i class="menu-arrow menu-arrow-pm"><span><span></span></span></i>';
                } elseif (isset($item['root']) == false && config('lm_team_layouts.menu.aside.submenu.arrow') == 'plus-minus-square') {
                    echo '<i class="menu-arrow menu-arrow-pm-square"><span><span></span></span></i>';
                } elseif (isset($item['root']) == false && config('lm_team_layouts.menu.aside.submenu.arrow') == 'plus-minus-circle') {
                    echo '<i class="menu-arrow menu-arrow-pm-circle"><span><span></span></span></i>';
                } else {
                    if (@$item['arrow'] !== false && config('lm_team_layouts.aside.menu.root-arrow') !== false) {
