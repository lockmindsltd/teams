...
class Metronic
{
    ...
    {
        if (config('lm_team_layouts.resources.fonts.google.families')) {
            $fonts = config('lm_team_layouts.resources.fonts.google.families');
    ...
    {
        $css_path = 'vendor/teams/'.$css_path;
    ...
    public static function initThemes()
    {
        ...
        $themes[] = 'vendor/teams/css/themes/layout/header/base/'.config('lm_team_layouts.header.self.theme').'.css';
        $themes[] = 'vendor/teams/css/themes/layout/header/menu/'.config('lm_team_layouts.header.menu.desktop.submenu.theme').'.css';
        $themes[] = 'vendor/teams/css/themes/layout/aside/'.config('lm_team_layouts.aside.self.theme').'.css';

        if (config('lm_team_layouts.aside.self.display')) {
            $themes[] = 'vendor/teams/css/themes/layout/brand/'.config('lm_team_layouts.brand.self.theme').'.css';
        } else {
            $themes[] = 'vendor/teams/css/themes/layout/brand/'.config('lm_team_layouts.header.self.theme').'.css';
        }
    ...
    {
        $filepath = 'vendor/teams/'.$filepath;
