...
return [
    ...
    // Page loader
    'page-loader' => [
        'type' => 'logo' // default, spinner-message, spinner-logo
    ],
    ...
    'resources' => [
        ...
        'css' => [
            'vendor/teams/plugins/global/plugins.bundle.css',
            'vendor/teams/plugins/custom/prismjs/prismjs.bundle.css',
            'vendor/teams/css/style.bundle.css',
        ],
        'js' => [
            'vendor/teams/plugins/global/plugins.bundle.js',
            'vendor/teams/plugins/custom/prismjs/prismjs.bundle.js',
            'vendor/teams/js/scripts.bundle.js',
        ],
    ],
